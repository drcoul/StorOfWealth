Contributing to Store of Wealth Coin Core
============================

The Store of Wealth Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Store of Wealth Coin Core project, and is not to be
confused with overall Store of Wealth Coin Network Protocol consensus changes.

Whether a pull request is merged into Store of Wealth Coin Core rests with the project merge
...
Patches that change Store of Wealth Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Store of Wealth Coin consensus, it must have been
...
The project leader is the release manager for each Store of Wealth Coin Core release.
