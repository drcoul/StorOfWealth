...
In order to support loading of multiple wallets in storofwealth-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is storofwealth.cpp.
...
Changes to storofwealth.cpp
----------------------
storofwealth.cpp is the entry point into storofwealth-qt, and as such, will require some minor modifications to provide hooks for
