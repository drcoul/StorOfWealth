...
- Detached signatures will then be committed to the [lasvegascoin-detached-sigs](https://github.com/StorOfWealth-Project/lasvegascoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
