...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 60702;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Store of Wealth Coin starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 24 * 365 * 12; //Halving each year for ~35 years
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 5 * 60; // Store of Wealth Coin: 0.25 day
        nTargetSpacing = 5 * 60;  // Store of Wealth Coin: 5 minutes
        nMaturity = 250;
        ...
        const char* pszTimestamp = "08-07-2017 - Vegas Baby! - Welcome to fabulous Store of Wealth :)";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "storofwealth-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "storofwealth-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet storofwealth addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet storofwealth script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet storofwealth BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet storofwealth BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet storofwealth BIP44 coin type is '1' (All coin's testnet default)
