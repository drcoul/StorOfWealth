...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SOW);
    unitlist.append(mSOW);
    unitlist.append(uSOW);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SOW:
            return QString("tSOW");
        case mSOW:
            return QString("mtSOW");
        case uSOW:
            return QString::fromUtf8("μtSOW");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SOW:
            return QString("SOW");
        case mSOW:
            return QString("Milli-SOW (1 / 1" THIN_SP_UTF8 "000)");
        case uSOW:
            return QString("Micro-SOW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SOW:
            return QString("TestSOWs");
        case mSOW:
            return QString("Milli-TestSOW (1 / 1" THIN_SP_UTF8 "000)");
        case uSOW:
            return QString("Micro-TestSOW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
