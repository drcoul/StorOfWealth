...
/** Utility functions used by the Store of Wealth Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render Store of Wealth Coin addresses in monospace font
...
// Parse "storofwealth:" URI into recipient object, return true on successful parsing
