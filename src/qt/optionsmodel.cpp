...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SOW);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeStorOfWealthAmount"))
        SoftSetArg("-anonymizestorofwealthamount", settings.value("nAnonymizeStorOfWealthAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in storofwealth.cpp during shotdown to also remove the window positions
