...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Store of Wealth Coin Core"),
     ...
     * override -datadir in the storofwealth.conf file in the default data directory
     * (to be consistent with storofwealthd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
