                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Store of Wealth Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Store of Wealth Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and storofwealth: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Store of Wealth Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Store of Wealth Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Store of Wealth Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Store of Wealth Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Store of Wealth Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Store of Wealth Coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Store of Wealth Coin Core help message to get a list with possible Store of Wealth Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Store of Wealth Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Store of Wealth Coin network", "", count));
}
...
{
    QString strTitle = tr("Store of Wealth Coin Core"); // default title
    ...
    // Append title to "Store of Wealth Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
