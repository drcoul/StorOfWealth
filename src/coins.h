...
/** 
    ...
    ****Note - for Store of Wealth Coin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of storofwealth coming in to a transaction
