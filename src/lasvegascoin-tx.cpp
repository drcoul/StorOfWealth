...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StorOfWealth Core storofwealth-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  storofwealth-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded storofwealth transaction") + "\n" +
                               "  storofwealth-tx [options] -create [commands]   " + _("Create hex-encoded storofwealth transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded storofwealth transaction
